    ...
    if ($result->num_rows > 0) {
        ...
        if ($cek_result->num_rows == 0) {
            ...
            if ($conn->query($insert)) {
                ...
                $pesan = "Gagal menyimpan absen keluar.";
            }
        } else {
            $pesan = "Anda sudah absen keluar hari ini!";
            $sudah_absen = true;
        }
    } else {
...
<div class="container">
    ...
    <div class="title"><h2>Absen Keluar</h2></div>
    <form method="POST">
        ...
        <button type="submit">Kirim Absen Keluar</button>
...
<div class="modal" id="modalSudahAbsen" style="display: <?= $sudah_absen ? 'flex' : 'none' ?>">
    <div class="modal-content">
        <h5>⚠️ Anda sudah absen keluar hari ini!</h5>
